 ...
 * 	<head>
 * 		<meta charset="utf-8" />
 * 		<title>Центр компьютерной помощи в Лыткарино</title>
 * 		<style>
 * 			.container {width:25%;margin:0 auto;}
 * 			.hyphenate {text-align: justify;}
 * 		</style>
 * 	</head>
 * 	<body>
 * 		<div class="container">
 * 			<p class="hyphenate text" lang="ru">
 * 				Ремонтируем компьютеры по правильным ценам. Наш перечень услуг по обслуживанию компьютеров насчитывает более 200 позиций, средняя цена одной услуги — 300 рублей.
 * 				Удалим вирусы и шпионские программы, установим лицензионноое антивирусное программное обеспечение, подберем оптимальный вариант защиты компьютера.
 * 				Современные персональные компьютеры построены по модульной системе, что позволяет проводить модернизацию, и получать существенно более производительный компьютер.
 * 			</p>
 * 		</div>
 * 		<script src="./4.2.0/js/hyphenator.min.js"></script>
 * 	</body>
 * </html>
 */
